...
![quality comparison at](quality-comp-at.gif)

![quality comparison at zoom](quality-comp-at-zoom.gif)
...
![Render of a biliear kernel and its threshold](kernel-samples.webp)
...
![Render of a biliear kernel and with line sampling](kernel-lines-rotation-comp.webp)
...
![kernels with simple derivatives](simple-derivatives.webp)
...
![Flower absolute error comparison](flower-diff-comp-32x.gif)

![@ absolute error comparison](at-diff-comp-32x.gif)
...
![Line with point and line sampling](line-sampling-comp.webp)
