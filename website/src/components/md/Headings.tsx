...
export const H2: Components["h2"] = memo(({ children, node }) => {
    ...
    return (
        <h2
            id={id}
            className="font-header mb-8 mt-10 overflow-hidden border-b-2 border-b-neutral-500 pr-4 pt-8 text-center text-2xl text-white md:text-4xl print:text-black"
        >
...
export const H3: Components["h3"] = memo(({ children, node }) => {
    ...
    return (
        <h3
            id={id}
            className="font-header narrow mb-6 mt-16 overflow-hidden border-b-2 border-dashed border-b-neutral-500 text-xl text-white md:text-2xl print:text-black"
        >
            <HeaderLink id={id}>{children}</HeaderLink>
        </h3>
    );
...
export const H4: Components["h4"] = memo(({ children, node }) => {
    ...
    return (
        <h4
            id={id}
            className="font-header narrow mb-4 mt-12 overflow-hidden border-b-2 border-dotted border-b-neutral-700 text-lg text-white md:text-xl print:text-black"
        >
            <HeaderLink id={id}>{children}</HeaderLink>
        </h4>
    );
