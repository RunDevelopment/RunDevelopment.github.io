...
export const H1: Components["h1"] = memo(({ children }) => {
    return (
        <h1 className="mb-10 text-balance text-center text-3xl leading-10 text-white md:mb-12 md:text-4xl md:leading-[3rem] print:text-black">
            {children}
        </h1>
    );
});
...
export const H3: Components["h3"] = memo(({ children, node }) => {
    ...
    return (
        <h3
            id={id}
            className="narrow mb-4 mt-12 overflow-hidden border-b-2 border-dashed border-b-neutral-500 text-xl text-white md:text-2xl print:text-black"
        >
            <HeaderLink id={id}>{children}</HeaderLink>
        </h3>
    );
...
export const H4: Components["h4"] = memo(({ children, node }) => {
    ...
    return (
        <h4
            id={id}
            className="narrow mb-4 mt-12 overflow-hidden border-b-2 border-dotted border-b-neutral-700 text-lg text-white md:text-xl print:text-black"
        >
            <HeaderLink id={id}>{children}</HeaderLink>
        </h4>
    );
